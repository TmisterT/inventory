                        ...
                        <form method="POST" action="{{ route('register')}}" class="my-4">
                            @csrf
                              ...
                              <div class="form-group mb-3">
                                ...
                                <input class="form-control" name="name" type="text" id="name" required="" placeholder="Enter your Fullname">
                            </div>
                    ...
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <h3 class="text-dark mb-3 pera-title">"Report Corruption System"</h3>
