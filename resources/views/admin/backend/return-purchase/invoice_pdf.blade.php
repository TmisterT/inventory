    ...
    <div class="invoice-container">
        <div class="invoice-header">
            <div style="display: flex; align-items: center; justify-content: center; gap: 15px;">
                <!-- Kiribati coat of arms embedded as Base64 -->
                  <img src="{{ asset('backend/kiribati/kiribati.png') }}" 
                     alt="Kiribati Coat of Arms" 
                     style="height: 50px; width: auto; background:#fff; padding:3px; border-radius:4px;">
                <h5 style="margin: 0;">Purchase Invoice</h5>
            </div>
        </div>
